...
export default function Page() {
  return (
    <div className="bg-zinc-800 h-screen flex justify-center items-center">
      ...
      <div className="z-10 absolute top-80 left-4 ml-1 bg-slate-800 text-white rounded px-4 py-2">
        Snap Point
      </div>

      <div className="relative h-full flex flex-col gap-6 overflow-y-auto pb-14 snap-y snap-mandatory">
